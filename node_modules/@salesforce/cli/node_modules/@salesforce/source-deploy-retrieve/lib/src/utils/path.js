...
exports.fnJoin = exports.calculateRelativePath = exports.parseNestedFullName = exports.parseMetadataXml = exports.trimUntil = exports.parentName = exports.extName = exports.baseWithoutSuffixes = exports.baseName = void 0;
 ...
 * @param fsPath The path to evaluate
 */
function baseWithoutSuffixes(fsPath, suffix) {
    return (0, node_path_1.basename)(fsPath)
        .replace(constants_1.META_XML_SUFFIX, '')
        .split('.')
