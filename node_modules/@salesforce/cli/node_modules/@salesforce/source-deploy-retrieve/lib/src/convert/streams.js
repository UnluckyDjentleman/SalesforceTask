...
class JsToXml extends node_stream_1.Readable {
    ...
    _read() {
        ...
        const xmlContent = constants_1.XML_DECL.concat(handleSpecialEntities(builtXml));
...
const existsOrDoesntMatchIgnored = (ignoredPaths) => (writeInfo) => (0, graceful_fs_1.existsSync)(writeInfo.output) ||
    [...ignoredPaths].every((ignoredPath) => !(0, node_path_1.dirname)(ignoredPath).includes((0, node_path_1.dirname)(writeInfo.output)) &&
        !(0, node_path_1.basename)(ignoredPath).includes((0, node_path_1.basename)(writeInfo.output)));
