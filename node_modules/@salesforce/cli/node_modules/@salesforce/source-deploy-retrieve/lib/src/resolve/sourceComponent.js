    ...
    getChildren() {
        if (!this.parent && this.type.children) {
            ...
            children
                ...
                .map((child) => {
                throw new core_1.SfError(messages.getMessage('error_unexpected_child_type', [child.xml ?? child.content, this.type.name]), 'TypeInferenceError');
            });
            return children;
        }
        return [];
        ...
        for (const fsPath of this.walk(dirPath)) {
            ...
            if (childXml && !fileIsRootXml && this.type.children && childXml.suffix) {
                ...
                const childComponent = new SourceComponent({
                    name: childSuffix ? (0, path_1.baseWithoutSuffixes)(fsPath, childSuffix) : (0, path_1.baseName)(fsPath),
