...
const posix_2 = require("node:path/posix");
...
const createResponses = (component, responseMessages) => {
    const responses = responseMessages.flatMap((message) => {
...
const toKey = (component) => {
    ...
    return `${type}#${exports.shouldConvertPaths ? component.fullName.split(posix_2.sep).join(posix_2.posix.sep) : component.fullName}`;
};
exports.toKey = toKey;
const isTrue = (value) => value === 'true' || value === true;
exports.shouldConvertPaths = posix_2.sep !== posix_2.posix.sep;
