...
class ShadowRepo {
    ...
    async getStatus(noCache = false) {
        ...
        if (!this.status || noCache) {
            const marker = core_2.Performance.mark('@salesforce/source-tracking', 'localShadowRepo.getStatus#withoutCache');
    ...
    async commitChanges({ deployedFiles = [], deletedFiles = [], message = 'sfdx source tracking', needsUpdatedStatus = true, } = {}) {
        ...
        const marker = core_2.Performance.mark('@salesforce/source-tracking', 'localShadowRepo.commitChanges', {
        ...
        if (deployedFiles.length) {
            ...
            [...new Set(this.isWindows ? deployedFiles.map(normalize).map(ensurePosix) : deployedFiles)], this.maxFileAdd);
