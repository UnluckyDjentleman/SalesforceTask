...
class SourceTracking extends kit_1.AsyncCreatable {
    ...
    async updateRemoteTracking(fileResponses, skipPolling = false) {
        const marker = core_2.Performance.mark('@salesforce/source-tracking', 'SourceTracking.updateRemoteTracking');
     ...
     */
    async getConflicts() {
        const marker = core_2.Performance.mark('@salesforce/source-tracking', 'SourceTracking.getConflicts');
