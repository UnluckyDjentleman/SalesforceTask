...
export declare abstract class SfCommand<T> extends Command {
    ...
    static baseFlags: {
        'flags-dir': import("@oclif/core/lib/interfaces/parser.js").OptionFlag<string | undefined, import("@oclif/core/lib/interfaces/parser.js").CustomOptions>;
    };
    /**
    ...
    protected catch(error: Error | SfError | SfCommand.Error): Promise<never>;
