...
import { DeleteSourceJson } from '../../../utils/types.js';
export declare class Source extends SfCommand<DeleteSourceJson> {
    ...
    static readonly flags: {
        ...
        tests: Interfaces.OptionFlag<string[] | undefined, Interfaces.CustomOptions>;
        'test-level': Interfaces.OptionFlag<import("../../../utils/types.js").TestLevel, Interfaces.CustomOptions>;
