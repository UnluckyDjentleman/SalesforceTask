...
export const makePathRelative = (fr) => fr.filePath ? { ...fr, filePath: path.relative(process.cwd(), fr.filePath) } : fr;
/**
 * Sorts file responds by type, then by filePath, then by fullName
 */
export const fileResponseSortFn = (i, j) => {
...
export const getFileResponseSuccessProps = (s) => ({
    filePath: s.filePath,
    fullName: s.fullName,
    type: s.type,
    state: s.state,
